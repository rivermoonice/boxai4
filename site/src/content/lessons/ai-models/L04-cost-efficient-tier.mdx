...
For the full Chinese open-weight landscape, see [L03](/lessons/ai-models/l03-chinese-open-weight/). For tier-routing in a real harness, see [Hermes L01](/lessons/hermes/l01-what-is-hermes-agent/) and [Hermes L06](/lessons/hermes/l06-performance-model-routing-cost/).
...
See the standalone quiz at [`/lessons/ai-models/L04-cost-efficient-tier/quiz.json`](/lessons/ai-models/L04-cost-efficient-tier/quiz.json) (5 questions).

...
"Don't assume 'open-weight' means 'free to run.'" You still pay for tokens via the API, or electricity plus GPU time if you self-host. The $5 DeepSeek starter covers weeks of testing — but the bill isn't zero.
</Callout>
...
Quiz: see [`quiz.json`](/lessons/ai-models/l03-chinese-open-weight/quiz.json) (6 questions, valid JSON).

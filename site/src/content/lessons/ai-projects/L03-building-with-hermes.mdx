...
The review step is the one beginners skip. They ship on Sunday evening, push to main, walk away. Three weeks later the auth flow doesn't match the spec. `/verify-spec` takes 15 minutes. Always run it before you deploy.
</Callout>

...
**Ron's bottom line:** start with the catalog and only the catalog. The four commands are all you need for your first week. Graduate to custom MCPs only when the catalog doesn't cover the app you need. Never accept a default tool whitelist without reading it.
</Callout>
---
title: 'How to Test the Quality Gate for Beginners in 2026 (Step-by-Step, No Setup Required)'
summary: ''
description: 'A short hook that explains why this lesson exists. This paragraph is here to satisfy the word-count target and to demonstrate the template renders correctly under the quality gate.'
module: 'hermes'
slug: 'l00-smoke-test'
order: 0

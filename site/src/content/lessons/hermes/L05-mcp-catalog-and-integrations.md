---
title: 'How to Connect Hermes Agent to Other Apps with the MCP Catalog (2026)'
summary: ''
description: 'Once Hermes is your daily driver, you''ll want it to do more than chat. You''ll want it to read GitHub issues, post to Linear, fetch a Notion page, or trigger an n8n workflow. That''s what MCP is for…'
module: 'hermes'
